    ...
    <html>
      <body style="font-family: Arial; background:#0f172a; padding:20px; color:white;">
        <div style="max-width:500px;margin:auto;background:rgba(255,255,255,0.05);padding:25px;border-radius:15px;text-align:center;">
          ...
          <p style="text-align:left;">Dear <b>{first_name}</b>,</p>
          ...
          <a href="{link}" style="display:inline-block;margin-top:20px;padding:12px 25px;background:linear-gradient(90deg,#0072FF,#00C6FF);color:white;text-decoration:none;border-radius:25px;font-weight:bold;">
            Verify Email
          </a>
